...
//        bots.add(loader.getBotClass("control.bots.MortalBot"));
    ...
    public void criarTela() {
       ...
       game = new SnakeGame(mazeSize, head0, tailDirection0, head1, tailDirection1, snakeSize, bot0, bot1);
...
//                Jogo jogo = new Jogo(this.game, this.window);
//                jogo.iniciarjogo();

                Thread t = new Thread(new Jogo(game, window));
