...
public class bfs implements Bot {
    ...
    private Direction breadFirstSearch(Snake snake, Snake opponent, Coordinate mazeSize, Coordinate apple) {
        ...
        // Cria uma matriz onde o valor true é onde já tem um caminho ou você não quer ir
        ...
        // A cabeça não pode ir
        arrayVisited[head.x][head.y] = true; // No need to check head

        // Todo o corpo também não pode ir (incluindo oponente)
        ...
        // Se a cobra tá atrás em pontos ignora os locais onde pode haver colisão com a outra cobra
        ...
        // Um dicionário por coordenada de como chegar na cobra
